...
function fallbackSettings(locale: Locale): SiteSettings {
  return {
    ...
    hours_text: locale === "es" ? "Lun-Sab 9:00 AM - 7:00 PM" : "Mon-Sat 9:00 AM - 7:00 PM",
    hero_headline:
      locale === "es"
    ...
    hero_subheadline:
      locale === "es"
        ? "Descubre un inventario seleccionado de vehiculos premium en OMB AUTO SALES."
...
export async function getPublicSiteSettings(locale: Locale = "en") {
  ...
  if (locale === "es") {
    ...
    if (next.hero_subheadline === "Discover a curated inventory of premium vehicles at OMB AUTO SALES.") {
      next.hero_subheadline = "Descubre un inventario seleccionado de vehiculos premium en OMB AUTO SALES.";
    }
    if (next.hours_text === "Mon-Sat 9:00 AM - 7:00 PM") {
      next.hours_text = "Lun-Sab 9:00 AM - 7:00 PM";
    }
